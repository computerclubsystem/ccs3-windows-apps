...
public class WindowsInterop {
    ...
    public const ACCESS_MASK DesktopEnumerateAccessRights = ACCESS_MASK.DESKTOP_ENUMERATE;
    public const ACCESS_MASK DesktopSwitchAccessRights = ACCESS_MASK.DESKTOP_SWITCHDESKTOP;

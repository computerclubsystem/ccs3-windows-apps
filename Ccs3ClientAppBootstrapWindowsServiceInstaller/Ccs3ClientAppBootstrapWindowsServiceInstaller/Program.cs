...
internal class Program {
    ...
    static int Main(string[] args) {
        ...
        SetEnvironmentVariables(
            ...
            cmdParams.PcConnectorServiceCertificateThumbprint
        );
    ...
    private static void SetEnvironmentVariables(
        ...
        string? pcConnectorServiceCertificateThumbprint
    ) {
        if (!string.IsNullOrWhiteSpace(staticFilesServiceBaseUrl)) {
        ...
        if (!string.IsNullOrWhiteSpace(pcConnectorServiceBaseUrl)) {
        ...
        if (!string.IsNullOrWhiteSpace(clientAppServiceLocalBaseUrl)) {
        ...
        if (!string.IsNullOrWhiteSpace(certificateAuthorityIssuerCertificateThumbprint)) {
        ...
        if (!string.IsNullOrWhiteSpace(pcConnectorServiceCertificateThumbprint)) {
            Console.WriteLine("Setting environment variable {0} to '{1}'", Ccs3EnvironmentVariableNames.CCS3_PC_CONNECTOR_SERVICE_CERTIFICATE_THUMBPRINT, pcConnectorServiceCertificateThumbprint);
            Environment.SetEnvironmentVariable(Ccs3EnvironmentVariableNames.CCS3_PC_CONNECTOR_SERVICE_CERTIFICATE_THUMBPRINT, pcConnectorServiceCertificateThumbprint, EnvironmentVariableTarget.Machine);
        }
    }
        ...
        for (int i = 0; i < args.Length; i++) {
            switch (args[i]) {
                ...
                case "--certificate-authority-issuer-certificate-thumbprint":
                    ...
                    i++;
                    break;
                case "--pc-connector-service-certificate-thumbprint":
    ...
    private static void ShowUsage() {
        ...
        Console.WriteLine();
        Console.WriteLine("Ccs3ClientAppBootstrapWindowsServiceInstaller.exe [--static-files-service-base-url https://<name-or-ip-address>:<port>] [--pc-connector-service-base-url https://<name-or-ip-address>:<port>] [--client-app-windows-service-local-base-url https://localhost:<port> [--certificate-authority-issuer-certificate-thumbprint <thumbprint>] [--pc-connector-service-certificate-thumbprint <thumbprint>]");
        Console.WriteLine();
        ...
        Console.WriteLine("- Optional parameter --pc-connector-service-certificate-thumbprint specified the thumbprint of the PC Connector service certificate");
